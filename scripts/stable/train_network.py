...
class NetworkTrainer:
    ...
    def train(self, args):
        ...
        # Disable sample-target based budget path: keep epoch/step semantics only.
        args.target_global_train_samples = None
        args.staged_phase_target_global_samples = None
        ...
        def save_model_hook(models, weights, output_dir):
            ...
            # keep deepspeed compatibility while using per-machine save role
            if is_saving_process or args.deepspeed:
                remove_indices = []
        ...
        for epoch in range(epoch_to_start, num_train_epochs):
            ...
            if args.save_every_n_epochs is not None:
                ...
                if is_saving_process and saving:
